  ...
  return (
    <div className="space-y-6 theme-gradient-bg min-h-screen p-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold" style={{ color: '#853655' }}>Dashboard</h1>
        ...
        <div className="flex space-x-2">
          ...
          <Button variant="outline" className="border-[#E8B9BB] text-[#853655] hover:bg-[#E8B9BB]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="theme-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Calendar className="h-4 w-4" style={{ color: '#853655' }} />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold" style={{ color: '#853655' }}>12</div>
        ...
        <Card className="theme-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Users className="h-4 w-4" style={{ color: '#E8B9BB' }} />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold" style={{ color: '#853655' }}>47</div>
            <p className="text-xs text-gray-500 mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 theme-card">
          <CardHeader>
            <CardTitle className="flex items-center" style={{ color: '#853655' }}>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center justify-between p-3 rounded-lg border" style={{ borderColor: '#E8B9BB' }}>
                  <div className="flex items-center space-x-3">
                    <div className="text-sm font-medium" style={{ color: '#853655' }}>{appointment.time}</div>
                    <div>
        ...
        <div className="space-y-6">
          ...
          <Card className="theme-card">
            <CardHeader>
              <CardTitle style={{ color: '#853655' }}>Thao tác nhanh</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <Button variant="outline" className="w-full justify-start border-[#E8B9BB] text-[#853655] hover:bg-[#E8B9BB]">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex items-start space-x-3 p-2 rounded border-l-4" style={{ borderLeftColor: '#E8B9BB' }}>
                <Clock className="h-4 w-4 mt-0.5" style={{ color: '#853655' }} />
                <div>
